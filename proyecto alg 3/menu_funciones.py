...
class menu():
    """"Clase que representa el menú de opciones del programa."""
    def __init__(self):
        pass

    def consultar_obra(self):
        """Consulta obras en el MET por diferentes criterios."""
    ...
    def mostrar_menu(self):
        """Muestra el menú principal y permite al usuario interactuar con él."""
        while True:
